...
class SelectSalesNumber extends StatefulWidget {
  ...
  @override
  _SelectSalesNumberState createState() => _SelectSalesNumberState();
}

// ignore: file_names
class _SelectSalesNumberState extends State<SelectSalesNumber> {
                          ...
                          return InkWell(
                            onTap: () => setState(
                              () {
                                ...
                                SalesShowCustomerDetailsState().setFlatNumber(
