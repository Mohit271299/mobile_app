...
class SelectSalesTown extends StatefulWidget {
  @override
  SelectSalesTownState createState() => SelectSalesTownState();
}

// ignore: file_names
class SelectSalesTownState extends State<SelectSalesTown> {
