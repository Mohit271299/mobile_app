...
class EstimateSelectCustomerDetails extends StatefulWidget {
  String customerName;
  String customerMobileNo;
  String customerEstimateNo;

  EstimateSelectCustomerDetails({
    required this.customerName,
    required this.customerEstimateNo,
    required this.customerMobileNo,
  });

  @override
  EstimateSelectCustomerDetailsState createState() =>
      EstimateSelectCustomerDetailsState();
}

class EstimateSelectCustomerDetailsState
    extends State<EstimateSelectCustomerDetails> {
  ...
  @override
  void initState() {
    // estimateShowCustomerDetailsController.onInit();
    super.initState();
  }
                ...
                Flexible(
                  child: InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'Estimate No. ${widget.customerEstimateNo.toString()}',
