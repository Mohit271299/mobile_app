...
class ProductSelectCustomer extends StatefulWidget {
  const ProductSelectCustomer({Key? key}) : super(key: key);

  @override
  _ProductSelectCustomerState createState() => _ProductSelectCustomerState();
}

class _ProductSelectCustomerState extends State<ProductSelectCustomer> {
  ProductController PurchaseController = Get.put(
    ProductController(),
    tag: ProductController().toString(),
  );
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return InkWell(
                        onTap: () {
                          ...
                          // gotoPurchaseShowDetailScreen(context);
                        },
                        child: Container(
