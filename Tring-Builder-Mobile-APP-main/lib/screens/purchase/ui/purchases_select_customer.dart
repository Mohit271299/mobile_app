...
class PurchaseSelectCustomer extends StatefulWidget {
  const PurchaseSelectCustomer({Key? key}) : super(key: key);

  @override
  _PurchaseSelectCustomerState createState() => _PurchaseSelectCustomerState();
}

class _PurchaseSelectCustomerState extends State<PurchaseSelectCustomer> {
  ...
  void initState() {
    super.initState();
    PurchaseController.getAllCustomerFromAPI();
  }
                      ...
                      return InkWell(
                        onTap: () {
                          ...
                          gotoPurchaseShowDetailScreen(
                            context,
                            custMobileNo: PurchaseController.getAllCustomerDetails!.data![index].mobileNo.toString(),
                            custNo: '00',
                            custName: PurchaseController.getAllCustomerDetails!.data![index].name.toString(), selectCustomerId: PurchaseController.getAllCustomerDetails!.data![index].id.toString(),
                          );
                        },
                        child: Container(
