...
class taxInvoiceEditScreen extends StatefulWidget {
  final int? tax_invoice_id;
  final VoidCallback? callback;

  taxInvoiceEditScreen({this.tax_invoice_id, this.callback});

  @override
  _taxInvoiceEditScreenState createState() => _taxInvoiceEditScreenState();
}

class _taxInvoiceEditScreenState extends State<taxInvoiceEditScreen> {
  GlobalKey<ScaffoldState>? _globalKey = GlobalKey<ScaffoldState>();
  final TaxInvoice_Edit_controller _taxInvoiceEditController = Get.put(
      TaxInvoice_Edit_controller(),
      tag: TaxInvoice_Edit_controller().toString());
  ...
  Future<void> add_product() async {
    ...
    await showModalBottomSheet(
      ...
      model.add(edit_tax_invoice_model(
      ...
      model_texable.add(texable_value(
  ...
  Future<void> _show_DatePicker_SO(ctx) async {
    DateTime? pickedDate = await showDatePicker(
        context: context,
        initialDate: DateTime.now(),
        firstDate: DateTime(2000),
...
// "https://magnetbackend.fsp.media/api/taxinvoice/6"
  ...
  List<edit_tax_invoice_model> model = [];

  List<texable_value> model_texable = [];
  ...
  Future tax_invoice_Edit_get() async {
    Token = await PreferenceManager().getPref(Api_url.token);
    var url =
        'https://magnetbackend.fsp.media/api/taxinvoice/${widget.tax_invoice_id}}';
    ...
    return Scaffold(
      ...
      body: custom_header(
        ...
        data: InkWell(
          ...
          child: GetBuilder<TaxInvoice_Edit_controller>(
              init: _taxInvoiceEditController,
              builder: (_) {
                return Container(
                                                          ...
                                                          children: [
                                                            Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                  '${model[index].product_qnty} * ${model[index].product_rate}',
                                                                  style:
                                                                      FontStyleUtility
                                                                          .h11(
                                                                    fontColor:
                                                              ...
                                                              children: [
                                                                (selectedValue ==
                                                                    ...
                                                                    : (selectedValue ==
                                                                            'inclusive_tax'
                                                                        ? Text(
                                                                            model_texable[index].product_texable_incl,
                                                                            style:
                                                                                FontStyleUtility.h12(
                                                                              fontColor: ColorUtils.blackColor,
                                                                              fontWeight: FWT.bold,
                                                                        ...
                                                                        : (selectedValue ==
                                                                                'out_of_tax'
                                                                            ? Text(
                                                                                model_texable[index].product_texable_excl,
                                                                                style: FontStyleUtility.h12(
                                                                                  fontColor: ColorUtils.blackColor,
                                                                                  fontWeight: FWT.bold,
                                                                                ),
  ...
  Future tax_invoice_API() async {
    ...
    var url = Api_url.tax_invoice_add_api + '/${widget.tax_invoice_id}';
