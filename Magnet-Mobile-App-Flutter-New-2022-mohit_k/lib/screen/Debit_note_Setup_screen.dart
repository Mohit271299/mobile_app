...
class debit_noteScreen extends StatefulWidget {
  const debit_noteScreen({Key? key}) : super(key: key);

  @override
  _debit_noteScreenState createState() => _debit_noteScreenState();
}

class _debit_noteScreenState extends State<debit_noteScreen> {
  GlobalKey<ScaffoldState>? _globalKey = GlobalKey<ScaffoldState>();
  final Debit_note_Setup_controller _debit_note_controller =
      Get.find(tag: Debit_note_Setup_controller().toString());
  ...
  TextEditingController DebitNoteNumberController = new TextEditingController();
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                          onTap: () {
                            ...
                            print(VendorsData[index].addresses![0].addressType);
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                        'Balance: ${VendorsData[index].openingBalance} CR',
                                        style: FontStyleUtility.h12(
                                          fontColor: ColorUtils.ogfont,
                                          fontWeight: FWT.semiBold,
                                        )),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            Get.toNamed(
                                BindingUtils.tax_invoice_setup_ScreenRoute);
                          },
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                          onTap: () {
                            ...
                            setState(() {
                              vendro_invoice_no =
                                  purchaseInvoiceList_data[index]
                                      ["invoice_number"];
                              vendor_invoice_id =
                                  purchaseInvoiceList_data[index]["id"];
                            });
                                ...
                                Expanded(
                                  ...
                                  child: Container(
                                    margin: EdgeInsets.only(
                                        left: 0, top: 0, right: 15),
                                    child: Text(
                                      'Balance: ${purchaseInvoiceList_data[index]["total_amt"]} CR',
                                      style: FontStyleUtility.h12(
                                        fontColor: ColorUtils.ogfont,
                                        fontWeight: FWT.semiBold,
                                      ),
    ...
    return Scaffold(
      ...
      body: custom_header(
        ...
        data: GestureDetector(
          ...
          child: GetBuilder<Debit_note_Setup_controller>(
              init: _debit_note_controller,
              builder: (_) {
                return Container(
                            ...
                            Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      decoration: BoxDecoration(
                                          border: (debit_no_validate == false
                                              ? Border.all(
                                                  color: Colors.red, width: 1)
                                              : Border.all(
                                                  color: Colors.transparent)),
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            if (vendor_name == null ||
                                              ...
                                              if (DebitNoteNumberController
                                                  .text.isEmpty) {
                                                setState(() {
                                                  debit_no_validate = false;
                                                });
                                              }
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          text: TextSpan(
                                            ...
                                            children: <TextSpan>[
                                              TextSpan(
                                                text: DebitNoteNumberController
                                                    .text,
                                                style: FontStyleUtility.h15(
                                                  fontColor:
  ...
  Future debit_note_API() async {
    ...
    var url = Api_url.debit_note_add_api;
