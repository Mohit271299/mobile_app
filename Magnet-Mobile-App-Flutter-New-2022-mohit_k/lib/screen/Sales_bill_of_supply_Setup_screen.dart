...
class billSupplyScreen extends StatefulWidget {

  @override
  _billSupplyScreenState createState() => _billSupplyScreenState();
}

class _billSupplyScreenState extends State<billSupplyScreen> {
  GlobalKey<ScaffoldState>? _globalKey = GlobalKey<ScaffoldState>();
  final Bill_supply_Setup_controller _bill_supply_controller =
  Get.find(tag: Bill_supply_Setup_controller().toString());
  ...
  TextEditingController bill_supplyNumberController = new TextEditingController();
    ...
    return Scaffold(
      ...
      body:custom_header(
        ...
        data:  GestureDetector(
          ...
          child: GetBuilder<Bill_supply_Setup_controller>(
              init: _bill_supply_controller,
              builder: (_) {
                return Container(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: CustomTextFieldWidget_two(
                                            ...
                                            controller: bill_supplyNumberController,
                                            keyboardType: TextInputType.number,
                                        ...
                                        Container(
                                          decoration: BoxDecoration(
                                              border: (place_supply_validate == false
                                                  ? Border.all(
                                                  color: Colors.red, width: 1)
                                                  : Border.all(
                                                  color: Colors.transparent)),
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                if (customer_name == null ||
                                                  ...
                                                  if (bill_supplyNumberController
                                                      .text.isEmpty) {
                                                    setState(() {
  ...
  Future bill_Supply_API() async {
    ...
    Map data = {
      ...
      "bill_of_supply_number": bill_supplyNumberController.text,
    ...
    var url = Api_url.bill_of_supply_add_api;
