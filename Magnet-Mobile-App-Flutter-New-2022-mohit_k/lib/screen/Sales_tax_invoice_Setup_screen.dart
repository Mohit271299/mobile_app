...
class taxInvoiceScreen extends StatefulWidget {
  ...
  const taxInvoiceScreen({Key? key, this.customer_id, this.customer_name})
      : super(key: key);
...
class _taxInvoiceScreenState extends State<taxInvoiceScreen> {
  ...
  final Tax_Invoice_Setup_controller _taxInvoicescreenController = Get.put(
      Tax_Invoice_Setup_controller(),
      tag: Tax_Invoice_Setup_controller().toString());
  ...
  TextEditingController product_quantity_controller =
      new TextEditingController();
  final product_rate_controller = new TextEditingController();
  ...
  @override
  void initState() {
    customer_billing_name = widget.customer_name;
    ...
    return Scaffold(
      ...
      body: custom_header(
        ...
        data: InkWell(
          ...
          child: GetBuilder<Tax_Invoice_Setup_controller>(
              init: _taxInvoicescreenController,
              builder: (_) {
                return Container(
  ...
  Future tax_invoice_API() async {
    ...
    print('calling');
    print(product_quantity_controller.text);
    print("product_quantity_controller.text");
    print(product_rate_controller.text);
    print(product_tax_controller.text);
    print(product_discount_controller.text);
    print("product_discount_controller.text");
    ...
    var url = Api_url.tax_invoice_add_api;
