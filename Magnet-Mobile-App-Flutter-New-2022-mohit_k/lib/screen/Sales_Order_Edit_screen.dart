...
import 'package:magnet_update/model_edit_class/remove_sales_order.dart';
...
class salesEditScreen extends StatefulWidget {
  ...
  const salesEditScreen({Key? key, this.sales_id}) : super(key: key);
...
class _salesEditScreenState extends State<salesEditScreen> {
  ...
  final Sales_order_Edit_controller _salesOrderEditController = Get.put(
      Sales_order_Edit_controller(),
      tag: Sales_order_Edit_controller().toString());
  ...
  TextEditingController sales_orderdateController = new TextEditingController();
  ...
  TextEditingController sales_orderNumberController =
  ...
  Future<void> add_product() async {
    await showModalBottomSheet(
      ...
      model.add(edit_sales_order_model(
      ...
      model_texable.add(sales_texable_value(
  ...
  Future<void> _showIOS_DatePicker(ctx) async {
    ...
    if (pickedDate != null) {
      ...
      setState(() {
        sales_orderdateController.text =
  ...
  List<edit_sales_order_model> model = [];

  List<sales_texable_value> model_texable = [];
  ...
  Future sales_Edit_get() async {
    Token = await PreferenceManager().getPref(Api_url.token);
    var url =
        'https://magnetbackend.fsp.media/api/sales-order/${widget.sales_id}}';
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        sales_orderdateController.text = data["sales_order_date"];
        sales_orderNumberController.text = data["sales_order_number"];
    ...
    return Scaffold(
        ...
        body: custom_header(
          ...
          data: InkWell(
            ...
            child: GetBuilder<Sales_order_Edit_controller>(
                init: _salesOrderEditController,
                builder: (_) {
                  return Stack(
                    children: [
                      Container(
  ...
  Future sales_order_API() async {
    ...
    Map data = {
      ...
      "sales_order_number": sales_orderNumberController.text,
      "sales_order_date": sales_orderdateController.text,
    ...
    var url = Api_url.sells_order_add_api + '/${widget.sales_id}';
