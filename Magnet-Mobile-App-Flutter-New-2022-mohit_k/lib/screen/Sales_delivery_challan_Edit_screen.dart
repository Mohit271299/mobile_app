...
import 'package:magnet_update/model_edit_class/remove_delivery_challan.dart';
...
class deliveryChallanEditScreen extends StatefulWidget {
  final int? delivery_challan_id;

  const deliveryChallanEditScreen({Key? key, this.delivery_challan_id})
      : super(key: key);

  @override
  _deliveryChallanEditScreenState createState() =>
      _deliveryChallanEditScreenState();
}

class _deliveryChallanEditScreenState extends State<deliveryChallanEditScreen> {
  GlobalKey<ScaffoldState>? _globalKey = GlobalKey<ScaffoldState>();
  final DeliveryChallan_Edit_controller _deliveryChallanEditController =
      Get.put(DeliveryChallan_Edit_controller(),
          tag: DeliveryChallan_Edit_controller().toString());
  ...
  TextEditingController mode_ofTransportation_Controller =
      new TextEditingController();
  ...
  TextEditingController terms_condition_controller =
      new TextEditingController();
  ...
  Future<void> add_product() async {
    ...
    await showModalBottomSheet(
      ...
      model.add(edit_delivery_challan_model(
      ...
      model_texable.add(texable_delivery_challan_value(
  ...
  init() async{
    ...
    await  delivery_challan_Edit_get();
  ...
  List<edit_delivery_challan_model> model = [];

  List<texable_delivery_challan_value> model_texable = [];
  ...
  Future delivery_challan_Edit_get() async {
    Token = await PreferenceManager().getPref(Api_url.token);
    var url =
        'https://magnetbackend.fsp.media/api/delivery-challan/${widget.delivery_challan_id}}';
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        challanNumberController.text = data["challan_number"];
        DateTime _date = DateTime.parse(data["challan_date"]);
        print("_date");
        print(_date);
        challandateController.text =  DateFormat('dd-MM-yyyy').format(_date);

        DateTime _date2 = DateTime.parse(data["date_of_removal"]);
        print("_date");
        print(_date2);
        DoRController.text = DateFormat('dd-MM-yyyy').format(_date2);

        shipping_Address_Controller.text = data["shipping_address"];
        Gst_no_Controller.text = data["gst_number"];
        transportNameController.text = data["transporter_name"];
        mode_ofTransportation_Controller.text = data["mode_of_transportation"];
        vehicle_numberController.text = data["vehicle_number"];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: custom_header(
          ...
          data: GetBuilder<DeliveryChallan_Edit_controller>(
              init: _deliveryChallanEditController,
              builder: (_) {
                return PageView(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: CustomTextFieldWidget_two(
                                        ...
                                        controller:
                                            mode_ofTransportation_Controller,
                                      ),
                                    ),
                                    Container(
                                      margin: EdgeInsets.only(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        GestureDetector(
                                          onTap: () {
                                            _deliveryChallanEditController
                                                .pageIndexUpdate('02');
                                      ...
                                      onTap: () {
                                        showDialog(
                                          ...
                                          builder: (_) => BankDialog(
                                              ifsc_controller: ifsc_controller,
  ...
  Future delivery_challan_API() async {
    ...
    Map data = {
      ...
      "total_amt_word": (selectedValue == 'exclusive_tax'
          ...
          : (selectedValue == 'inclusive_tax'
              ? "$word_incl"
              : (selectedValue == 'out_of_tax' ? "$word_exl" : '-'))),
      "balance_due": 0,
    ...
    var url =
        Api_url.delivery_challan_add_api + '/${widget.delivery_challan_id}';
