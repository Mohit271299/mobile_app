...
import 'package:magnet_update/model_edit_class/remove_purchase_order.dart';
...
class _purchaseEditScreenState extends State<purchaseEditScreen> {
  ...
  final Purchase_order_Edit_controller _purchaseOrderEditController = Get.put(
      Purchase_order_Edit_controller(),
      tag: Purchase_order_Edit_controller().toString());
  ...
  Future<void> add_product() async {
    await showModalBottomSheet(
      ...
      model.add(edit_purchase_order_model(
      ...
      model_texable.add(purchase_texable_value(
  ...
  List<edit_purchase_order_model> model = [];

  List<purchase_texable_value> model_texable = [];
  ...
  Future purchase_Edit_get() async {
    ...
    var url =
        'https://magnetbackend.fsp.media/api/purchase-order/${widget.purchase_id}}';
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        vendors = data["vendor"];
        purchase_orderdateController.text = data["purchase_order_date"];
        purchase_orderNumberController.text = data["purchase_order_number"];
        ...
        Vendor_billing_name = vendors["billing_name"];
        Vendor_name = vendors["account_name"];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: custom_header(
        ...
        data: GetBuilder<Purchase_order_Edit_controller>(
            init: _purchaseOrderEditController,
            builder: (_) {
              return PageView(
  ...
  Future purchase_order_API() async {
    ...
    var url = Api_url.purchase_order_add_api + '/${widget.purchase_id}';
