...
class sales_orderScreen extends StatefulWidget {
  const sales_orderScreen({Key? key}) : super(key: key);

  @override
  _sales_orderScreenState createState() => _sales_orderScreenState();
}

class _sales_orderScreenState extends State<sales_orderScreen> {
  GlobalKey<ScaffoldState>? _globalKey = GlobalKey<ScaffoldState>();
  final Sales_order_Setup_controller _sales_order_controller =
  Get.find(tag: Sales_order_Setup_controller().toString());
  ...
  TextEditingController sales_orderNumberController = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: custom_header(
        ...
        child: GetBuilder<Sales_order_Setup_controller>(
            init: _sales_order_controller,
            builder: (_) {
              return Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: CustomTextFieldWidget_two(
                                          controller: sales_orderNumberController,
                                          keyboardType: TextInputType.number,
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          sales_orderdateController.text.trim(),
                                          style: FontStyleUtility.h15(
                                            fontColor:
                                            ColorUtils.whiteColor,
                                            fontWeight: FWT.bold,
  ...
  Future sales_order_API() async {
    ...
    var url = Api_url.sells_order_add_api;
