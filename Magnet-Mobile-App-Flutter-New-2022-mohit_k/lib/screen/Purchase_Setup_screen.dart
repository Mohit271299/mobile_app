...
class purchaseSetupScreen extends StatefulWidget {
  final int? vendor_id;
  final String? vendor_name;

  const purchaseSetupScreen({Key? key, this.vendor_id, this.vendor_name})
      : super(key: key);

  @override
  _purchaseSetupScreenState createState() => _purchaseSetupScreenState();
}

class _purchaseSetupScreenState extends State<purchaseSetupScreen> {
  GlobalKey<ScaffoldState>? _globalKey = GlobalKey<ScaffoldState>();
  final Purchase_Setup_controller _purchase_setup_screencontroller = Get.put(
      Purchase_Setup_controller(),
      tag: Purchase_Setup_controller().toString());
  ...
  @override
  void initState() {
    Vendor_billing_name = widget.vendor_name;
    ...
    return Scaffold(
        ...
        body: custom_header(
          ...
          data: InkWell(
            ...
            child: GetBuilder<Purchase_Setup_controller>(
                init: _purchase_setup_screencontroller,
                builder: (_) {
                  return Container(
                                        ...
                                        children: [
                                          GestureDetector(
                                            onTap: () {
                                              ...
                                              _purchase_setup_screencontroller
                                                  .pageIndexUpdate('02');
                                ...
                                builder: (FormFieldState<String> state) {
                                  return DropdownButtonHideUnderline(
                                    child: DropdownButton2(
                                      ...
                                      iconSize: 25,
                                      icon:
                                          SvgPicture.asset(AssetUtils.drop_svg),
  ...
  Future purchase_API() async {
    ...
    var url = Api_url.purchase_add_api;
