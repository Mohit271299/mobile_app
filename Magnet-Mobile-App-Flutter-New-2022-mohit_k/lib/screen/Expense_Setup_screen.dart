...
class expenseSetupScreen extends StatefulWidget {
  const expenseSetupScreen({Key? key}) : super(key: key);
...
class _expenseSetupScreenState extends State<expenseSetupScreen> {
  ...
  final Expense_Setup_controller _expense_setup_screenConrtoller =
      Get.find(tag: Expense_Setup_controller().toString());
  ...
  Addresses_customer? billing_cust;
  Addresses_Vendors? billing_vendor;
  Addresses_Others? billing_other;
      ...
      child: Column(
        children: [
          ListView.builder(
            ...
            itemCount: all_Ledger_CustomerData.length,
            itemBuilder: (BuildContext context, int index) {
              return GestureDetector(
                onTap: () {
                  ...
                  setState(() {
                    customer_name = all_Ledger_CustomerData[index].accountName;
                    vendor_validate = true;
                    customer_id = all_Ledger_CustomerData[index].id;
                    customer_billing_name =
                        all_Ledger_CustomerData[index].billingName;
                  });
                  print("addresses");
                  List address = all_Ledger_CustomerData[index].addresses!.toList();
                  print(address);

                  for(var i=0 ; i< address.length; i++){
                    if(address[i].addressType == "billing"){
                      billing_cust = address[i];
                      print("addres[i]");
                      // print(address[i]["state"]);
                    }
                  }
                  print("billing");
                  print(billing_cust!.state);
                  if(billing_cust != null){
                    Data_state _stdBilling = stateData.firstWhere(
                            (element) => element.id.toString() == billing_cust!.state);
                    ...
                    children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                    "${all_Ledger_CustomerData[index].companyName}",
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: Text(
                              'Balance: ${all_Ledger_CustomerData[index].openingBalance} CR',
                              style: FontStyleUtility.h12(
                                fontColor: ColorUtils.ogfont,
                                fontWeight: FWT.semiBold,
                              )
          ...
          ListView.builder(
            ...
            shrinkWrap: true,
            scrollDirection: Axis.vertical,
            itemCount: all_Ledger_VendorData.length,
            itemBuilder: (BuildContext context, int index) {
              return GestureDetector(
                onTap: () {
                  //  selected_customer= true;
                  ...
                  setState(() {
                    Vendor_name = all_Ledger_VendorData[index].accountName;
                    vendor_validate = true;
                    Vendor_id = all_Ledger_VendorData[index].id;
                    Vendor_billing_name = all_Ledger_VendorData[index].billingName;
                  });
                  print("Vendor_name");
                  print(Vendor_name);
                  print("Vendor_nid");
                  print(Vendor_id);
                  print("addresses");
                  List address = all_Ledger_VendorData[index].addresses!.toList();
                  print(address);

                  for(var i=0 ; i< address.length; i++){
                    if(address[i].addressType == "billing"){
                      billing_vendor = address[i];
                      print("addres[i]");
                      // print(address[i]["state"]);
                    }
                  }
                  print("billing");
                  print(billing_vendor!.state);
                  if(billing_vendor != null){
                    Data_state _stdBilling = stateData.firstWhere(
                            (element) => element.id.toString() == billing_vendor!.state);
                    print(_stdBilling.name);
                    setState(() {
                      _selectedstate = _stdBilling;
                    });
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                child: Text(
                                    "${all_Ledger_VendorData[index].billingName}",
                                    style: FontStyleUtility.h15(
                                      fontColor: ColorUtils.blackColor,
                                      fontWeight: FWT.semiBold,
                                    )),
                              ...
                              Container(
                                ...
                                child: Text(
                                    "${all_Ledger_VendorData[index].companyName}",
                                    style: FontStyleUtility.h12(
                                      fontColor: ColorUtils.ogfont,
                                      fontWeight: FWT.medium,
                                    )),
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          EdgeInsets.only(left: 0, top: 0, right: 15),
                          child: Text(
                              'Balance: ${all_Ledger_VendorData[index].openingBalance} CR ',
                              style: FontStyleUtility.h12(
                                fontColor: ColorUtils.ogfont,
                                fontWeight: FWT.semiBold,
                              )
          ...
          ListView.builder(
            ...
            shrinkWrap: true,
            scrollDirection: Axis.vertical,
            itemCount: all_Ledger_OtherData.length,
            itemBuilder: (BuildContext context, int index) {
              return GestureDetector(
                onTap: () {
                  //  selected_customer= true;
                  ...
                  setState(() {
                    other_name = all_Ledger_OtherData[index].accountName;
                    vendor_validate = true;
                    other_id = all_Ledger_OtherData[index].id;
                    other_billing_name = all_Ledger_OtherData[index].billingName;
                  });
                  print("other_name");
                  print(other_name);
                  print("other_id");
                  print(other_id);
                  List address = all_Ledger_OtherData[index].addresses!.toList();
                  print(address);

                  for(var i=0 ; i< address.length; i++){
                    if(address[i].addressType == "billing"){
                      billing_other = address[i];
                      print("addres[i]");
                      // print(address[i]["state"]);
                    }
                  }
                  ...
                  if(billing_other != null){
                    Data_state _stdBilling = stateData.firstWhere(
                            (element) => element.id.toString() == billing_other!.state);
                    print(_stdBilling.name);
                    setState(() {
                      _selectedstate = _stdBilling;
                    });
                    ...
                    children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                    "${all_Ledger_OtherData[index].billingName}",
                                    style: FontStyleUtility.h15(
                                      fontColor: ColorUtils.blackColor,
                                      fontWeight: FWT.semiBold,
                                    )),
                              ...
                              Container(
                                ...
                                child: Text(
                                    "${all_Ledger_OtherData[index].companyName}",
                                    style: FontStyleUtility.h12(
                                      fontColor: ColorUtils.ogfont,
                                      fontWeight: FWT.medium,
                                    )),
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          EdgeInsets.only(left: 0, top: 0, right: 15),
                          child: Text(
                              'Balance: ${all_Ledger_OtherData[index].openingBalance} CR',
                              style: FontStyleUtility.h12(
                                fontColor: ColorUtils.ogfont,
                                fontWeight: FWT.semiBold,
                              )
    ...
    return Scaffold(
      ...
      body: custom_header(
        ...
        data: GestureDetector(
          ...
          child: GetBuilder<Expense_Setup_controller>(
              init: _expense_setup_screenConrtoller,
              builder: (_) {
                return Container(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            child: SvgPicture.asset(
                                              AssetUtils.arrow_right,height: 10,
                                              width: 4,),
                                          ),
                                        ],
                                      ),
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            GestureDetector(
                                              onTap: () {
                                                if (customer_name == null && Vendor_name == null && other_name == null
                                                    || invoiceNumberController
                                                        .text.isEmpty ||
                                                    invoicedateController
                                                        .text.isEmpty ||
                                                    _selectedstate!.name!.isEmpty) {
                                                  ...
                                                  if ( _selectedstate!.name!.isEmpty) {
                                                    setState(() {
                                                ...
                                                _expense_setup_screenConrtoller
                                                    .pageIndexUpdate('02');
  ...
  Future Expanse_API() async {
    ...
    var url = Api_url.expanse_add_api;
  ...
  String query_all = '';
  List<Data_all_Customers> all_Ledger_CustomerData = [];
  List<Data_all_Vendors> all_Ledger_VendorData = [];
  List<Data_all_Others> all_Ledger_OtherData = [];
  ...
  Future fetchAdd() async {
    ...
    if (response.statusCode == 200) {
      ...
      var data = ressult['data'];
      print(data);
      List customer_data = data["customers"];
      List vendors_data = data["vendors"];
      List others_data = data["others"];
      print(customer_data);
      setState(() {
        all_Ledger_CustomerData = customer_data.map((json) => Data_all_Customers.fromJson(json)).toList();
        all_Ledger_VendorData = vendors_data.map((json) => Data_all_Vendors.fromJson(json)).toList();
        all_Ledger_OtherData = others_data.map((json) => Data_all_Others.fromJson(json)).toList();
      });
    }
    print(all_Ledger_CustomerData);
    print(all_Ledger_VendorData);
    print(all_Ledger_OtherData);
    // return all_Ledger_Data;
  }

  // Future fetch_list_search_API(String query) async {
  //   final books = await call_api.get_all_ledger_List(query);
  //
  //   if (!mounted) return;
  //
  //   setState(() {
  //     this.query_all = query;
  //     this.all_Ledger_CustomerData = books;
  //   });
  // }
