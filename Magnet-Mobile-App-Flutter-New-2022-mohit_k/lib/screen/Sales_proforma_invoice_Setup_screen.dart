...
class _proformaInvoiceScreenState extends State<proformaInvoiceScreen>  {
  ...
  final Proforma_invoice_Setup_controller _proforma_invoice_controller =
  Get.find(tag: Proforma_invoice_Setup_controller().toString());
    ...
    return Scaffold(
      ...
      body: custom_header(
        ...
        data: GestureDetector(
          ...
          child: GetBuilder<Proforma_invoice_Setup_controller>(
              init: _proforma_invoice_controller,
              builder: (_) {
                return Container(
