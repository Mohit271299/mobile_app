...
class _estimateScreenState extends State<estimateScreen> {
  ...
  final Estimate_Setup_controller _estimate_controller =
  Get.find(tag: Estimate_Setup_controller().toString());
    ...
    return Scaffold(
      ...
      body: custom_header(
        ...
        data: GestureDetector(
          ...
          child: GetBuilder<Estimate_Setup_controller>(
              init: _estimate_controller,
              builder: (_) {
                return Stack(
                  children: [
                    Container(
  ...
  Future Estimate_API() async {
    ...
    var url = Api_url.estimate_add_api;
