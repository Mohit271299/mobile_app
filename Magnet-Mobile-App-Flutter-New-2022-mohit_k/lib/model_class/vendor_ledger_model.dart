class vendorList {
  bool? success;
  List<Data_vendors>? data;

  vendorList({this.success, this.data});
  ...
  vendorList.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <Data_vendors>[];
      json['data'].forEach((v) {
        data!.add(new Data_vendors.fromJson(v));
      });
    }
  }
...
class Data_vendors {
  ...
  List<Addresse_vendor>? addresses;
  int? openingBalance;
  String? openingType;
  num? closingBalance;
  String? closingType;
  ...
  Data_vendors.fromJson(Map<String, dynamic> json) {
    ...
    if (json['addresses'] != null) {
      addresses = <Addresse_vendor>[];
      json['addresses'].forEach((v) {
        addresses!.add(new Addresse_vendor.fromJson(v));
      });
    }
...
class Addresse_vendor {
  ...
  Addresse_vendor.fromJson(Map<String, dynamic> json) {
    id = json['id'];
