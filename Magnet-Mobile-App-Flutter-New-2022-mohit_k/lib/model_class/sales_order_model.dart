class SalesModel {
  ...
  SalesModel.fromJson(dynamic json) {
    ...
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(Data_sales_order.fromJson(v));
      });
    }
  }
  bool? _success;
  List<Data_sales_order>? _data;

  bool? get success => _success;
  List<Data_sales_order>? get data => _data;
...
class Data_sales_order {
  ...
  Data_sales_order.fromJson(dynamic json) {
    _id = json['id'];
    _salesOrderNumber = json['sales_order_number'];
    _salesOrderDate = json['sales_order_date'];
  ...
  String? get salesOrderDate => _salesOrderDate;
  ...
  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    map['id'] = _id;
    map['sales_order_number'] = _salesOrderNumber;
    map['sales_order_date'] = _salesOrderDate;
...
class Product_items {
  ...
  dynamic get purchaseOrderId => _purchaseOrderId;
  int? get customerId => _customerId;
...
class Customer {
  ...
  dynamic get subGroupId => _subGroupId;
  dynamic get asOfDate => _asOfDate;
