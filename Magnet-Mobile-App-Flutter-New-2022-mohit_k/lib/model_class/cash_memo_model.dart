class cash_memoList {
  bool? success;
  List<Data_cash_memo>? data;

  cash_memoList({this.success, this.data});

  cash_memoList.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      data = <Data_cash_memo>[];
      json['data'].forEach((v) {
        data!.add(new Data_cash_memo.fromJson(v));
      });
    }
  }
...
class Data_cash_memo {
  ...
  Data_cash_memo.fromJson(Map<String, dynamic> json) {
    id = json['id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['cash_ledger_id'] = this.cashLedgerId;
