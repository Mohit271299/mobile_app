class contra_list {
  bool? success;
  List<Data_contra>? data;

  contra_list({this.success, this.data});

  contra_list.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      data = <Data_contra>[];
      json['data'].forEach((v) {
        data!.add(new Data_contra.fromJson(v));
      });
    }
  }
...
class Data_contra {
  ...
  Data_contra.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    cashBank = json['cash_bank'] != null
        ? new Other.fromJson(json['cash_bank'])
        : null;
