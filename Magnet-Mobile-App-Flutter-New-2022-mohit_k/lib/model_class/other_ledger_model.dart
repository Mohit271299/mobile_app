class othersList {
  bool? success;
  List<Data_others>? data;

  othersList({this.success, this.data});
  ...
  othersList.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <Data_others>[];
      json['data'].forEach((v) {
        data!.add(new Data_others.fromJson(v));
      });
    }
  }
...
class Data_others {
  ...
  Data_others.fromJson(Map<String, dynamic> json) {
    ...
    if (json['addresses'] != null) {
      addresses = <Addresse_other>[];
      json['addresses'].forEach((v) {
        addresses!.add(new Addresse_other.fromJson(v));
      });
    }
...
class Addresse_other {
  ...
  Addresse_other.fromJson(Map<String, dynamic> json) {
    id = json['id'];
