class bill_supplyList {
  bool? success;
  List<Data_bill_supply>? data;

  bill_supplyList({this.success, this.data});

  bill_supplyList.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      data = <Data_bill_supply>[];
      json['data'].forEach((v) {
        data!.add(new Data_bill_supply.fromJson(v));
      });
    }
  }
...
class Data_bill_supply {
  int? id;
  String? billOfSupplyNumber;
  int? customerId;
  String? invoiceDate;
  String? gstNumber;
  ...
  Data_bill_supply.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    billOfSupplyNumber = json['bill_of_supply_number'];
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['id'] = this.id;
    data['bill_of_supply_number'] = this.billOfSupplyNumber;
