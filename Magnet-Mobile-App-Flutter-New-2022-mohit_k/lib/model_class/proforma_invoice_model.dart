class proforma_invoiceList {
  bool? success;
  List<Data_proforma_invoice>? data;

  proforma_invoiceList({this.success, this.data});

  proforma_invoiceList.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      data = <Data_proforma_invoice>[];
      json['data'].forEach((v) {
        data!.add(new Data_proforma_invoice.fromJson(v));
      });
    }
  }
...
class Data_proforma_invoice {
  ...
  Data_proforma_invoice.fromJson(Map<String, dynamic> json) {
    id = json['id'];
